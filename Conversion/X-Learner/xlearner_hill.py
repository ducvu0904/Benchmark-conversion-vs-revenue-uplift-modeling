...
def get_xlearner(task_type, params, seed=None):
    """
    ...
    seed : int | None
        Seed cho toàn bộ model con LightGBM trong X-Learner.
    ...
    if task_type == 'conversion':
        ...
        models = LGBMClassifier(**model_params)
    ...
    propensity_model = LGBMClassifier(**model_params)
    ...
    cate_models = LGBMRegressor(**model_params)
